export const URL_understanding_default_roles = 'https://gethelp.GPTMysite.com/articles/understanding-default-roles/' // 'https://docs.GPTMysite.com/knowledge-base/understanding-default-roles/'
...
export function getWidgetWebInstallationScript(projectID: string, widgetBaseUrl: string): {html, javascript} {
    return {
        ...
        "       i.q=[]; i.c=function(args){i.q.push(args);}; w.GPTMysite=i;\n"+     
